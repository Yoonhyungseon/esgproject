            ...
            <div class="container">
                <div class="single-bottom-blog">
                    <div class="bottom-grid mt-4 pt-2">
                        <h3 class="find-id" style="text-align: center;">아이디 찾기</h3>
	                        ...
	                        <div class="row main-cont-sec" style="display: flex;justify-content: center;">
	                            <div class="col-md-6 left-cont-contact">
	                                ...
	                                <div class="form-group-2 mt-4 login-button" style="width: 100%;">
			                            <button type="button" class="btn button-style d-flex ml-auto" onclick="findIdValidation()" style="width: 100%;justify-content: center;border-radius: 7px;">완료</button>
			                        </div>
	                            </div>
	                        </div>
	                    </form>
