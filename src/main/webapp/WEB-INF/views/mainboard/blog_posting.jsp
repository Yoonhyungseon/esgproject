...
<head>
    ...
    <title>Foodies - Restaurant Category Responsive Web Template - Blog Single</title>
    <!-- google-fonts -->
 ...
 <!--header-->
    ...
    <div class="inner-banner">
        <section class="w3l-breadcrumb">
            <div class="container">
                <h4 class="inner-text-title font-weight-bold mb-sm-3 mb-2">Posting</h4>
    ...
    <!-- //inner banner -->
                    ...
                    <section class="w3l-form-comments-sec mt-5 ">
                        <div class="coments-forms-sub ">
                            <h3 class="title-main2-blog-single">Write your posting</h3>
                            <div class="form-commets">
                                <form action="#" method="post">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <input type="text" name="Title" required="Title" placeholder="Posting Title">
                                        </div>
                                        <br>
                ...
                <div class="row footer-p">
                    <div class="col-lg-4 pr-lg-5">
                        <a class="logo" href="index.html"><i class="fa fa-cutlery" aria-hidden="true"></i>
                            Foodies</a>
                        <p class="mt-4">Duis imperdiet sapien tortor, vitae congue diam auctor vitae.
                            Aliquam
