...
<head>
    ...
    <title>Foodies - Restaurant Category Responsive Web Template - Landing Page</title>
    <!-- google-fonts -->
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 pt-md-0 pt-4">
                    ...
                    <div class="mt-md-5 mt-4 mb-lg-0 mb-4">
                        <a class="btn button-style" href="#about">View Our Menu</a>
                    </div>
                </div>
            ...
            <div class="container py-lg-4 py-md-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 content-left mb-md-0 mb-3">
                        ...
                        <a class="btn button-style" href="#about">Read More </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="w3l-content-11-main" id="chefs">
        <div class="content-design-11 pt-md-4 pt-1 pb-5">
            <div class="container pb-md-4 pb-3">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="position-relative">
                                    ...
                                    <div class="text-position">
                                        <h4><a href="#about">Jimic Nasium</a></h4>
                                        <p>Best Chef</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 mt-sm-0 mt-4">
                                <div class="position-relative">
                                    ...
                                    <div class="text-position">
                                        <h4><a href="#about">Henry Itondo</a></h4>
                                        <p>Food Expert</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="content-sec-11 mt-5 pt-lg-4" id="services">
                    <div class="row">
    ...
    <!-- //video section -->
    <!-- blog section -->
    <section class="w3l-blog-sec py-5" id="blog">
                            ...
                            <div class="serve-info">
                                ...
                                <ul class="admin-list">
                                    ...
                                    <li><a href="#blog"><span class="fa fa-heart" aria-hidden="true"></span>9
                                            Likes</a></li>
                                    <li><a href="#blog"><span class="fa fa-comments" aria-hidden="true"></span>9
                                            Comments</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="services-gd">
                            <div class="serve-info">
                                ...
                                <ul class="admin-list">
                                    ...
                                    <li><a href="#blog"><span class="fa fa-heart" aria-hidden="true"></span>9
                                            Likes</a></li>
                                    <li><a href="#blog"><span class="fa fa-comments" aria-hidden="true"></span>8
                                            Comments</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="grid">
                    ...
                    <div class="float-rt text-right">
                        <ul class="buttons">
                            ...
                            <li><a href="#contact" class="btn button-style">Get in touch</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row features4-grids">
                    <div class="col-lg-4 col-md-6">
                        <div class="features4-grid">
                            ...
                            <h5><a href="#contact">Fast Delivery</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                        <div class="features4-grid">
                            ...
                            <h5><a href="#contact">Fresh Ingredients</a></h5>
                            <p>Lorem ante ipsum primis in faucibus orci luctus eted ultrices posuere curae fers
                                luctus eted.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                        <div class="features4-grid">
                            ...
                            <h5><a href="#contact">Online Suport 24/7</a></h5>
                            <p>Lorem ante ipsum primis in faucibus orci luctus eted ultrices posuere curae fers
                                luctus eted.</p>
                        </div>
                    </div>
