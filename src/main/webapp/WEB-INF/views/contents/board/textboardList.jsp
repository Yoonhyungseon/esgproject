            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="serve-info">
                                ...
                                <ul class="admin-list">
                                    <li><a href="textboardView"><span class="fa fa-user-circle"
                                                aria-hidden="true"></span>
                                            Admin</a></li>
                                    <li><a href="textboardView"><span class="fa fa-heart" aria-hidden="true"></span>8
                                            Likes</a></li>
                                    <li><a href="textboardView"><span class="fa fa-comments"
                    ...
                    <div class="col-lg-4 col-md-6 mt-md-5 mt-4 column column-img" id="zoomIn">
                        ...
                        <br>
                        <button class="btn button-style d-flex ml-auto" onClick="location.href='${pageContext.request.contextPath}textboardWrite'" type="submit">Posting</button>
                    </div>
                </div>
                <!-- pagination -->
